...
def run():
    ...
    st.markdown("<h2 style='text-align: center;'>🛠️ Resume Improvement Suggestions</h2>", unsafe_allow_html=True)
    ...
    if "resume_bytes" in st.session_state and "jd" in st.session_state:
        ...
        prompt = """
        As a Technical HR Manager, give concrete improvement suggestions to make this resume a 100% match for the job description.
        """
